...
function Header() {
    ...
    return (
        <header className="wrapper h-[60px] shadow-[0px_1px_1px_rgb(0_0_0_/12%)] flex justify-center items-center fixed top-0 left-0 right-0 bg-white z-10">
            <div className="content w-[1024px] h-full flex justify-between items-center pr-[24px] pl-[20px]">
                ...
                <div className="basis-4/6 h-full flex justify-between items-center">
                    <Search />
